...
[ -z "$bundle1" ] && bundle1='Enterprise_Edition_12c'
[ -z "$bundle1_url" ] && bundle1_url=$(eval echo "\$${bundle1}_Release_1of2")
[ -z "$bundle2_url" ] && bundle2_url=$(eval echo "\$${bundle2}_Release_2of2")
