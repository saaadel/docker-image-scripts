...
## HOW TO USE:
# curl https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-hi-res-optimized.sh | bash /dev/stdin


# FULLSCREEN
## 1920x1080 59.96 Hz (CVT 2.07M9) hsync: 67.16 kHz; pclk: 173.00 MHz
# Modeline "1920x1080_60.00"  173.00  1920 2048 2248 2576  1080 1083 1088 1120 -hsync +vsync
curl https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 1920 1080
...
curl https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 1920 1010

# FULLSCREEN
## 2560x1440 59.96 Hz (CVT 3.69M9) hsync: 89.52 kHz; pclk: 312.25 MHz
# Modeline "2560x1440_60.00"  312.25  2560 2752 3024 3488  1440 1443 1448 1493 -hsync +vsync
curl https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 2560 1440
...
curl https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 2560 1348
