...
curl -jkL https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 1920 1080
...
curl -jkL https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 1920 1010

# FULLSCREEN
## 2560x1440 59.96 Hz (CVT 3.69M9) hsync: 89.52 kHz; pclk: 312.25 MHz
# Modeline "2560x1440_60.00"  312.25  2560 2752 3024 3488  1440 1443 1448 1493 -hsync +vsync
curl -jkL https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 2560 1440
...
curl -jkL https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-echo-newmode.sh | bash /dev/stdin 2560 1348
...
curl -jkL https://raw.githubusercontent.com/saaadel/scripts/master/linux/xrandr-set-newmode.sh | bash /dev/stdin 1706 900
